/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv` (hash: 6e533902007b2005d1dfff3afb7e5f32)
// Runtime types generated with workerd@1.20251008.0 2025-01-18 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		MCP_ADMIN_API_KEY: string;
		GOOGLE_CLIENT_ID: string;
		GOOGLE_CLIENT_SECRET: string;
		YOUTUBE_REDIRECT_URI: string;
		GOOGLE_API_KEY: string;
		GEMINI_API_KEY: string;
		NEXT_PUBLIC_MCP_SERVER_URL: string;
		MCP_PERSONA: Fetcher /* twin-mcp-persona */;
	}
}
